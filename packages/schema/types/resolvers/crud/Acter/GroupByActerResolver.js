...
exports.GroupByActerResolver = void 0;
...
let GroupByActerResolver = class GroupByActerResolver {
...
], GroupByActerResolver.prototype, "groupByActer", null);
GroupByActerResolver = __decorate([
    TypeGraphQL.Resolver(_of => Acter_1.Acter)
], GroupByActerResolver);
exports.GroupByActerResolver = GroupByActerResolver;
