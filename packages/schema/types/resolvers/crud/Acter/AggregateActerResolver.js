...
exports.AggregateActerResolver = void 0;
...
let AggregateActerResolver = class AggregateActerResolver {
...
], AggregateActerResolver.prototype, "aggregateActer", null);
AggregateActerResolver = __decorate([
    TypeGraphQL.Resolver(_of => Acter_1.Acter)
], AggregateActerResolver);
exports.AggregateActerResolver = AggregateActerResolver;
