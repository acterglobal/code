...
let FindUniqueActerResolver = class FindUniqueActerResolver {
...
], FindUniqueActerResolver.prototype, "acter", null);
FindUniqueActerResolver = __decorate([
    TypeGraphQL.Resolver(_of => Acter_1.Acter)
], FindUniqueActerResolver);
exports.FindUniqueActerResolver = FindUniqueActerResolver;
