...
import { ActerInviteArgs } from "./args/ActerInviteArgs";
import { ActerNotificationsOnArgs } from "./args/ActerNotificationsOnArgs";
import { ActerNotificationsToArgs } from "./args/ActerNotificationsToArgs";
export declare class ActerRelationsResolver {
    ...
    NotificationsTo(acter: Acter, ctx: any, args: ActerNotificationsToArgs): Promise<Notification[]>;
    NotificationsOn(acter: Acter, ctx: any, args: ActerNotificationsOnArgs): Promise<Notification[]>;
    Invite(acter: Acter, ctx: any, args: ActerInviteArgs): Promise<Invite[]>;
}
