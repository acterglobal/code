...
const ActivityNotificationArgs_1 = require("./args/ActivityNotificationArgs");
...
let ActivityRelationsResolver = class ActivityRelationsResolver {
    ...
    async Notification(activity, ctx, args) {
        return (0, helpers_1.getPrismaFromContext)(ctx).activity.findUnique({
            where: {
                id: activity.id,
            },
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Activity_1.Activity, Object, ActivityNotificationArgs_1.ActivityNotificationArgs]),
    __metadata("design:returntype", Promise)
], ActivityRelationsResolver.prototype, "Notification", null);
