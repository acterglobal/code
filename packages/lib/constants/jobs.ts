...
export const DAILY_DIGEST_CREATE = 'daily-digest'
export const DAILY_DIGEST_CRON = 'daily-digest-cron'
export const POST_NOTIFICATIONS_QUEUE = 'post-notifications'
export const EMAIL_SEND_QUEUE = 'email-send'
export const INVITE_EMAIL_CREATE = 'invite-email-create'
export const INVITE_SEND_QUEUE = 'invite-send-queue'
export const NEW_MEMBER_NOTIFICATION_QUEUE = 'new-member-notification'
export const SYNC_AUTH0_INTERCOM_DATA = 'sync-auth0-intercom-data'
