...
export const getFollowers2 = (user: User, acter: Acter): Acter[] => {
  ...
  // const acterFollowersFilteredCreator = acter.Followers.filter(
  //   (follower) => !(isCreator && follower.Follower.id === user.Acter.id)
  // )
