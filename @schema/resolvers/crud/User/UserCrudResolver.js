...
let UserCrudResolver = class UserCrudResolver {
    async user(ctx, args) {
        return helpers_1.getPrismaFromContext(ctx).user.findUnique(args);
    }
    async findFirstUser(ctx, args) {
        return helpers_1.getPrismaFromContext(ctx).user.findFirst(args);
    }
    async users(ctx, args) {
        return helpers_1.getPrismaFromContext(ctx).user.findMany(args);
    }
    async createUser(ctx, args) {
        return helpers_1.getPrismaFromContext(ctx).user.create(args);
    }
    async deleteUser(ctx, args) {
        return helpers_1.getPrismaFromContext(ctx).user.delete(args);
    }
    async updateUser(ctx, args) {
        return helpers_1.getPrismaFromContext(ctx).user.update(args);
    }
    async deleteManyUser(ctx, args) {
        return helpers_1.getPrismaFromContext(ctx).user.deleteMany(args);
    }
    async updateManyUser(ctx, args) {
        return helpers_1.getPrismaFromContext(ctx).user.updateMany(args);
    }
    async upsertUser(ctx, args) {
        return helpers_1.getPrismaFromContext(ctx).user.upsert(args);
    }
